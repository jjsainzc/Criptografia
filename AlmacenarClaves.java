...
public class AlmacenarClaves {
	public static void main(String[] args) throws Exception {
                ...
                String archivo = "claves";

		System.out.println("Crea los ficheros "+archivo+".secreta, "
				+archivo+".publica, "+archivo+".privada");
		...
		FileOutputStream out = new FileOutputStream(archivo + ".privada");
		...
		FileInputStream in = new FileInputStream(archivo + ".privada");
		...
		out = new FileOutputStream(archivo + ".publica");
		...
		in = new FileInputStream(archivo + ".publica");
		...
		out = new FileOutputStream(archivo + ".secreta");
		...
		in = new FileInputStream(archivo + ".secreta");
